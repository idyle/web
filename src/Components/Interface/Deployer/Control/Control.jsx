...
const Control = ({ deploy, website }) => {
    ...
    return (
        <div className="grid grid-rows-[auto_minmax(0,_1fr)] text-gunmetal rounded-lg p-3 overflow-auto gap-y-2">
            ...
            <div className="grid gap-2 auto-rows-min overflow-auto">
                {
                    ...
                    : 
                    <div className="flex place-content-center p-2 border border-gumetal rounded-lg">
