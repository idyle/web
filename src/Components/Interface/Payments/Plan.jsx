...
const Plan = ({ plan, onClick, onCancel }) => {
    ...
    return (
        <div id={plan?.id} className="grid rounded-xl gap-10 p-5 justify-items-center select-none bg-gunmetal text-white">
...

            {
                ...
                <div className="grid w-full justify-items-center items-center">
                    <div id={plan?.id} className="grid grid-cols-[auto_minmax(0,_1fr)] w-full p-2 justify-items-center items-center bg-white text-gunmetal rounded-xl select-none">
                        <AiOutlineCheck size="30px" />
                ...
                {
                    plan?.active ?
                <div id={plan?.id} onClick={onClick} className="grid w-full p-1 items-center justify-items-center border border-white hover:bg-black hover:text-white rounded-xl select-none">
                    <h1 className="text-3xl text-center">Select Plan</h1>
                </div> 
                :
                <div id={plan?.id} className="grid w-full p-1 items-center justify-items-center border border-white rounded-xl select-none bg-gray-100">
