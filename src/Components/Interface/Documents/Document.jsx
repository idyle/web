...
const Document = ({ doc, onClick, currentDoc }) => {
    ...
    const color = currentDoc?.id === doc?.id && 'bg-black/10';
    ...
    return (
        <div id={doc?.id} onClick={sendDoc} className={`flex items-center border-b-2 border-gunmetal justify-between p-1 select-none rounded-lg text-gunmetal hover:bg-black/10 ${color} ${integrationMode}`}>
