...
const Confirmer = () => {
    ...
    return (
        <div className={`grid items-center justify-items-center ${confirmer?.active ? 'h-full' : 'h-0'} overflow-hidden absolute top-0 bottom-0 left-0 right-0 shadow bg-black/90`}>
