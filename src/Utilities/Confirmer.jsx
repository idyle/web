...
const Confirmer = () => {
    ...
    return (
        <div className={`grid items-center justify-items-center ${confirmer?.active ? 'h-full' : 'h-0'} overflow-hidden fixed top-0 bottom-0 left-0 right-0 shadow bg-black/90`}>
            <div className="grid items-center justify-items-center bg-white text-gunmetal rounded-xl opacity-100 p-20 gap-3 m-2">
                ...
                <div className="grid md:grid-cols-2 items-center justify-items-center gap-3">
                    ...
                    <div onClick={onCancel} className="flex items-center gap-1 border-2 border-inherit rounded-lg p-2 hover:scale-[.98] select-none">
                        <MdCancel size="30px" />
